	...
	return (
		<section className='py-32 relative overflow-hidden bg-background'>
			...
			<div className='mx-auto max-w-3xl px-6 lg:px-8 text-center relative z-10'>
				<h2 className='text-5xl font-extrabold tracking-tight text-white mb-8'>
					See what your agent really did.
				</h2>
				<p className='text-xl text-gray-400 mb-12 font-light leading-relaxed'>
					Join thousands of developers building reliable agents with Argus.
				</p>
					...
					<div className='relative bg-[#0f1016] rounded-xl p-4 overflow-hidden'>
						...
						<div className='font-mono text-sm text-white'>
							<div className='flex gap-2 mb-1'>
								...
								<span>npm install -g @argusai/cli</span>
							</div>
						</div>
					</div>
				</div>
				...
				<div className='flex flex-col items-center gap-6'>
					...
					<a
						...
						target='_blank'
						rel='noopener noreferrer'
						className='h-14 px-12 rounded-full bg-gradient-to-r from-primary to-secondary hover:brightness-110 text-white font-bold text-lg transition-all shadow-[0_0_40px_-10px_rgba(217,70,239,0.5)] hover:scale-105 inline-flex items-center justify-center'>
						Install Argus
					</a>
				</div>
			</div>
