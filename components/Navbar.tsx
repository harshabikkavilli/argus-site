...
import {Close, GitHub, Menu, Visibility} from './Icons';
...
const Navbar: React.FC = () => {
	...
	const navItems = [
		{name: 'Docs', href: '/docs/getting-started', isInternal: true},
		{name: 'Blog', href: '#', isInternal: false},
		{name: 'Community', href: '/docs/community', isInternal: true}
	];
				...
				<div className='mx-auto flex h-20 max-w-7xl items-center justify-between px-6 lg:px-8'>
					...
					<div className='flex items-center gap-3'>
						<a
							...
							href='https://github.com/harshabikkavilli/argus'
							target='_blank'
